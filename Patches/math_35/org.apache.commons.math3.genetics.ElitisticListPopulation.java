...
/*-- PATCH P1 --*/if(elitismRate > 1){throw new OutOfRangeException(null,null,null);}/*-- PATCH P1 --*/if(elitismRate < 0){throw new OutOfRangeException(null,null,null);}    }
    ...
    public ElitisticListPopulation(final int populationLimit, final double elitismRate) {
        ...
        this.elitismRate = elitismRate;
/*-- PATCH P1 --*/if(elitismRate < 0){throw new OutOfRangeException(null,null,null);}/*-- PATCH P1 --*/if(elitismRate > 1){throw new OutOfRangeException(null,null,null);}    }
